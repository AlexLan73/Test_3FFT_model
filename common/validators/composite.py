# vendored from DSP-GPU/DSP/Python/common/validators/composite.py (2026-07-14) — косметика под ruff (typing.List/Optional→list/X|None, сортировка импортов, неисп. импорты), логика не менялась.
"""
