...
- 🎯 **Физический арбитр гл.5 (передний край τ≥0)** (2026-07-18) — новый слой пайплайна после
  ...
  - **⚠️ Ограничение:** одиночные шумовые осколки заграда (~93 на чистом заграде) Вариант 1 не давит
    (§5.1 нельзя по яркости, §5.4 это работа Варианта 2 FM-m-кода) — **следующий шаг: `CodeArbiter`
    через FM-m коррелятор** (`waveforms/fm.py`, P4).
