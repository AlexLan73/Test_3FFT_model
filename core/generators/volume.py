...
from .tact_sequence import Tact
...
class VolumeBuilder:
    ...
    def build(self, state: TargetState, cfg: ProjectConfig, rng: np.random.Generator) -> np.ndarray:
        ...
        return self.build_from_sample(sample, cfg, rng)
