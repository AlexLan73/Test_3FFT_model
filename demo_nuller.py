...
Запуск:
    ...
    python demo_nuller.py --nx 6 --ny 15   # неквадратная апертура i×j (E5), паддинг до 2ⁿ
Сохраняет:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Демо SubspaceNuller (§E5: апертура i×j).")
